...
<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
  <ul class="main-nav nav navbar-nav navbar-right">
    <li class="wow fadeInDown" data-wow-delay="0s"><a class="active" href="#">Home</a></li></ul>
</div><!-- /.navbar-collapse -->
</div><!-- /.container-fluid -->
</nav>
<br>
<br>
<main>
<form class="form-horizontal" role="form" action="proses_input_perusahaan.php" method="post" enctype="multipart/form-data">
    <div class="space-4"></div>
    <div class="form-group">
        <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Nama Perusahaan </label>

    <div class="col-sm-4">
        <input type="text" id="form-field-1" name="nama" required="required" class="form-control col-sm-10 col-sm-5">
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-4">
        <input type="text" id="form-field-1" name="telp" required="required" class="form-control col-sm-10 col-sm-5">
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-4">
        <input type="text" id="form-field-1" name="alamat" required="required" class="form-control col-sm-10 col-sm-5">
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-4">
        <input type="text" id="form-field-1" name="email" required="required" class="form-control col-sm-10 col-sm-5">
    </div>
</div>
<div class="space-4"></div>
<div class="form-group">
    ...
    <div class="col-sm-4">
        <input type="text" id="form-field-1" name="password" required="required" class="form-control col-sm-10 col-sm-5">
    </div>
</div>
...
<div class="col-sm-4">
    <a href ="login_perusahaan.php?page=perusahaan">
